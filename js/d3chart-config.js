  ...
  parent.document.onreadystatechange = () => {
      if (parent.document.readyState === 'complete') {
          ...
          const observerOptions = {
              //childList: false,
              attributes: true
                  //subtree: false //set true to observe changes to children
          }
  ...
  // get the data
  d3.csv(`https://raw.githubusercontent.com/HuttonLandSystems/agmet_website/master/data/plantheatstress_count_${currentYear}.csv`, function(data) {
